...
*/
func (svc *Service) ValidateToken(ctx context.Context, signedToken string) (claims tokenissuerapi.MapClaims, valid bool, err error) { // MARKER: ValidateToken
...
*/
func (svc *Service) IssueToken(ctx context.Context, claims tokenissuerapi.MapClaims) (signedToken string, err error) { // MARKER: IssueToken
	...
	mapClaims["jti"] = utils.RandomIdentifier(24)
