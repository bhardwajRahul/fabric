...
// Client is a lightweight proxy for making unicast calls to the metrics.core microservice.
type Client struct {
...
// NewClient creates a new unicast client proxy to the metrics.core microservice.
...
// MulticastClient is a lightweight proxy for making multicast calls to the metrics.core microservice.
...
// NewMulticastClient creates a new multicast client proxy to the metrics.core microservice.
...
*/
func (_c Client) Collect(ctx context.Context, relURL string) (res *http.Response, err error) {
	res, err = _c.svc.Request(
		ctx,
		pub.Method("GET"),
		pub.URL(URLOfCollect),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) Collect(ctx context.Context, relURL string) <-chan *pub.Response {
