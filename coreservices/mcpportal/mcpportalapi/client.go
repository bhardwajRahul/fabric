...
/*
MCP is the JSON-RPC 2.0 wire endpoint for Model Context Protocol clients. It accepts an
envelope `{"jsonrpc":"2.0","method":"<m>","params":{...},"id":<n>}` and dispatches on
`method` to one of the supported handlers: `initialize`, `tools/list`, `tools/call`.
...
/*
MCP is the JSON-RPC 2.0 wire endpoint for Model Context Protocol clients.
