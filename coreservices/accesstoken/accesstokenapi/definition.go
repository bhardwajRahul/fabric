...
var KeyRotationInterval = define.Config{
...
var DefaultTokenLifetime = define.Config{
	Value:      time.Duration(0),
	Default:    "20s",
...
var MaxTokenLifetime = define.Config{
	Value:      time.Duration(0),
	Default:    "15m",
	Validation: "dur [1s,15m]",
}
