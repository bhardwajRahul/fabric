...
/*
TimeBudget is the hard ceiling on the execution time of any task step.
*/
...
/*
DefaultPriority is the priority assigned to a flow when the caller does not specify one.
*/
...
/*
NumShards is the number of database shards. Each shard is a separate database instance.
Shards can be added dynamically but never removed.
*/
...
// doSignal handles marshaling for the Signal function.
