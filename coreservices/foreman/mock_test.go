...
func TestForeman_Mock(t *testing.T) {
	...
	t.Run("create", func(t *testing.T) { // MARKER: Create
		...
		mock.MockCreate(func(ctx context.Context, workflowName string, initialState any, opts *workflow.FlowOptions) (flowKey string, err error) {
			return
		})
		var workflowName string
		var initialState any
		var opts *workflow.FlowOptions
		_, err := mock.Create(ctx, workflowName, initialState, opts)
		assert.NoError(err)
	})
