...
type Mock struct {
	*Intermediate
	mockCreate              func(ctx context.Context, workflowName string, initialState any) (flowKey string, err error)                      // MARKER: Create
...
func (svc *Mock) MockCreate(handler func(ctx context.Context, workflowName string, initialState any) (flowKey string, err error)) *Mock { // MARKER: Create
