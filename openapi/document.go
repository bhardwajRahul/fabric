...
// Doc is the legacy name of [Document]. Retained as an alias for backward compatibility
// with code written against the pre-v1.27 API.
//
...
// Tag groups a set of operations under a label, typically rendered as a collapsible section
// by OpenAPI tooling. The aggregator at the portal uses one tag per source service.
