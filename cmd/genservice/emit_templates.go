...
const clientPreamble = `// multicastResponse packs the response of a functional multicast.
...
const clientHelpers = `// marshalRequest supports functional endpoints.
