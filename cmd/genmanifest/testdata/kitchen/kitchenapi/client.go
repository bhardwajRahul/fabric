...
// MyFunc is kitchen's own function endpoint.
...
// SelfPing is used for peer-to-peer self-calls (broadcast across replicas).
...
// SelfPing is used for peer-to-peer unicast self-calls.
...
// OnMyEvent registers a hook for the OnMyEvent event.
func (_c Hook) OnMyEvent(handler func(ctx context.Context, note string) (ok bool, err error)) (err error) { // MARKER: OnMyEvent
	_ = handler
	return nil
}
