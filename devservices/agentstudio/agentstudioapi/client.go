...
/*
ListFlows shows the flow matrix.

If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) ListFlows(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: ListFlows
	return _c.svc.Request(
		ctx,
		pub.Method(ListFlows.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) ListFlows(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: ListFlows
...
/*
FlowDetail shows the details of a single flow.

If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) FlowDetail(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: FlowDetail
	return _c.svc.Request(
		ctx,
		pub.Method(FlowDetail.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) FlowDetail(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: FlowDetail
	return _c.svc.Publish(
		ctx,
		pub.Method(FlowDetail.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, FlowDetail.Route)),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) ListWorkflows(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: ListWorkflows
	return _c.svc.Request(
		ctx,
		pub.Method(ListWorkflows.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) ListWorkflows(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: ListWorkflows
	return _c.svc.Publish(
		ctx,
		pub.Method(ListWorkflows.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, ListWorkflows.Route)),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) WorkflowDetail(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: WorkflowDetail
	return _c.svc.Request(
		ctx,
		pub.Method(WorkflowDetail.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) WorkflowDetail(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: WorkflowDetail
	return _c.svc.Publish(
		ctx,
		pub.Method(WorkflowDetail.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, WorkflowDetail.Route)),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) TaskDetail(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: TaskDetail
	return _c.svc.Request(
		ctx,
		pub.Method(TaskDetail.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) TaskDetail(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: TaskDetail
	return _c.svc.Publish(
		ctx,
		pub.Method(TaskDetail.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, TaskDetail.Route)),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c Client) Dashboard(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: Dashboard
	return _c.svc.Request(
		ctx,
		pub.Method(Dashboard.Method),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) Dashboard(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: Dashboard
	return _c.svc.Publish(
		ctx,
		pub.Method(Dashboard.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, Dashboard.Route)),
