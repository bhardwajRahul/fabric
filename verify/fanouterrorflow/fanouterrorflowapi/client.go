...
*/
func (_c Executor) TaskE(ctx context.Context, handled, markB, markC, markD bool) (recovered bool, err error) { // MARKER: TaskE
	var out TaskEOut
...
*/
func (_c Executor) FanOutError(ctx context.Context) (recovered bool, status string, err error) { // MARKER: FanOutError
	if _c.runner == nil {
		return recovered, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out FanOutErrorOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, FanOutError.URL(), FanOutErrorIn{}, &out)
	return out.Recovered, status, err
}
