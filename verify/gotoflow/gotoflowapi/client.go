...
*/
func (_c Executor) TaskA(ctx context.Context, loops int) (loopsOut int, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{Loops: loops}, &out, _c.inFlow, _c.outFlow)
	return out.LoopsOut, err
}

/*
TaskB creates and runs the TaskB task.
*/
func (_c Executor) TaskB(ctx context.Context, loops, target int) (visited bool, err error) { // MARKER: TaskB
	var out TaskBOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskB.Method, TaskB.Route, TaskBIn{Loops: loops, Target: target}, &out, _c.inFlow, _c.outFlow)
...
*/
func (_c Executor) TaskC(ctx context.Context, loops int) (finalLoops int, err error) { // MARKER: TaskC
	var out TaskCOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskC.Method, TaskC.Route, TaskCIn{Loops: loops}, &out, _c.inFlow, _c.outFlow)
	return out.FinalLoops, err
}

/*
Goto creates and runs the Goto workflow.
*/
func (_c Executor) Goto(ctx context.Context, target int) (finalLoops int, status string, err error) { // MARKER: Goto
	if _c.runner == nil {
		return finalLoops, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out GotoOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Goto.URL(), GotoIn{Target: target}, &out)
	return out.FinalLoops, status, err
}

/*
BadGotoer creates and runs the BadGotoer task.
*/
func (_c Executor) BadGotoer(ctx context.Context) (stamp bool, err error) { // MARKER: BadGotoer
	var out BadGotoerOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, BadGotoer.Method, BadGotoer.Route, BadGotoerIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Stamp, err
}

/*
BadGoto creates and runs the BadGoto workflow.
*/
func (_c Executor) BadGoto(ctx context.Context) (stamp bool, status string, err error) { // MARKER: BadGoto
	if _c.runner == nil {
		return stamp, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out BadGotoOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, BadGoto.URL(), BadGotoIn{}, &out)
	return out.Stamp, status, err
}
