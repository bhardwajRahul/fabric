...
/*
TaskA creates and runs the TaskA task.
*/
func (_c Executor) TaskA(ctx context.Context) (started bool, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Started, err
}

/*
NormalB creates and runs the NormalB task.
*/
func (_c Executor) NormalB(ctx context.Context) (resultB string, err error) { // MARKER: NormalB
	var out NormalBOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, NormalB.Method, NormalB.Route, NormalBIn{}, &out, _c.inFlow, _c.outFlow)
	return out.ResultB, err
}

/*
TaskX creates and runs the TaskX task.
*/
func (_c Executor) TaskX(ctx context.Context) (xPassed bool, err error) { // MARKER: TaskX
	var out TaskXOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskX.Method, TaskX.Route, TaskXIn{}, &out, _c.inFlow, _c.outFlow)
	return out.XPassed, err
}

/*
TaskY creates and runs the TaskY task.
*/
func (_c Executor) TaskY(ctx context.Context, xPassed bool) (subResult string, err error) { // MARKER: TaskY
	var out TaskYOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskY.Method, TaskY.Route, TaskYIn{XPassed: xPassed}, &out, _c.inFlow, _c.outFlow)
	return out.SubResult, err
}

/*
NormalD creates and runs the NormalD task.
*/
func (_c Executor) NormalD(ctx context.Context) (resultD string, err error) { // MARKER: NormalD
	var out NormalDOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, NormalD.Method, NormalD.Route, NormalDIn{}, &out, _c.inFlow, _c.outFlow)
	return out.ResultD, err
}

/*
TaskE creates and runs the TaskE task.
*/
func (_c Executor) TaskE(ctx context.Context, resultB, subResult, resultD string) (finalResult string, err error) { // MARKER: TaskE
	var out TaskEOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskE.Method, TaskE.Route, TaskEIn{ResultB: resultB, SubResult: subResult, ResultD: resultD}, &out, _c.inFlow, _c.outFlow)
	return out.FinalResult, err
}

/*
Sub creates and runs the Sub workflow.
*/
func (_c Executor) Sub(ctx context.Context) (subResult string, status string, err error) { // MARKER: Sub
	if _c.runner == nil {
		return subResult, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out SubOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Sub.URL(), SubIn{}, &out)
	return out.SubResult, status, err
}

/*
SubFanOut creates and runs the SubFanOut workflow.
*/
func (_c Executor) SubFanOut(ctx context.Context) (finalResult string, status string, err error) { // MARKER: SubFanOut
	if _c.runner == nil {
		return finalResult, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out SubFanOutOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, SubFanOut.URL(), SubFanOutIn{}, &out)
	return out.FinalResult, status, err
}
