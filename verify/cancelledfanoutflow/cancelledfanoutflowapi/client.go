...
*/
func (_c Executor) B(ctx context.Context) (executedOut int, err error) { // MARKER: B
	var out BOut
...
*/
func (_c Executor) CancelledFanOut(ctx context.Context) (executed int, totalExecuted int, status string, err error) { // MARKER: CancelledFanOut
	if _c.runner == nil {
