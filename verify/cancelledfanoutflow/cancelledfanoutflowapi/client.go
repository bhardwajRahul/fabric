...
/*
Source creates and runs the Source task.
*/
func (_c Executor) Source(ctx context.Context) (started bool, err error) { // MARKER: Source
	var out SourceOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Source.Method, Source.Route, SourceIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Started, err // No trace
}
...
*/
func (_c Executor) B(ctx context.Context) (sumExecutedOut int, err error) { // MARKER: B
	var out BOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, B.Method, B.Route, BIn{}, &out, _c.inFlow, _c.outFlow)
	return out.SumExecutedOut, err // No trace
}
...
/*
CancelledFanOut creates and runs the CancelledFanOut workflow, blocking until termination.
*/
func (_c Executor) CancelledFanOut(ctx context.Context) (sumExecuted int, totalExecuted int, status string, err error) { // MARKER: CancelledFanOut
	if _c.runner == nil {
		return sumExecuted, totalExecuted, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out CancelledFanOutOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, CancelledFanOut.URL(), CancelledFanOutIn{}, &out)
