...
*/
func (_c Executor) TaskA(ctx context.Context, seed string) (seedOut string, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{Seed: seed}, &out, _c.inFlow, _c.outFlow)
	return out.SeedOut, err
}

/*
TaskX creates and runs the TaskX task.
*/
func (_c Executor) TaskX(ctx context.Context, seed string) (innerStage string, err error) { // MARKER: TaskX
	var out TaskXOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskX.Method, TaskX.Route, TaskXIn{Seed: seed}, &out, _c.inFlow, _c.outFlow)
...
*/
func (_c Executor) TaskY(ctx context.Context, innerStage string) (innerResult string, err error) { // MARKER: TaskY
	var out TaskYOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskY.Method, TaskY.Route, TaskYIn{InnerStage: innerStage}, &out, _c.inFlow, _c.outFlow)
...
*/
func (_c Executor) TaskZ(ctx context.Context, innerResult string) (finalResult string, err error) { // MARKER: TaskZ
	var out TaskZOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskZ.Method, TaskZ.Route, TaskZIn{InnerResult: innerResult}, &out, _c.inFlow, _c.outFlow)
...
*/
func (_c Executor) Inner(ctx context.Context, seed string) (innerResult string, status string, err error) { // MARKER: Inner
	if _c.runner == nil {
		return innerResult, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out InnerOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Inner.URL(), InnerIn{Seed: seed}, &out)
	return out.InnerResult, status, err
}

/*
Parent creates and runs the Parent workflow.
*/
func (_c Executor) Parent(ctx context.Context, seed string) (finalResult string, status string, err error) { // MARKER: Parent
	if _c.runner == nil {
		return finalResult, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out ParentOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Parent.URL(), ParentIn{Seed: seed}, &out)
