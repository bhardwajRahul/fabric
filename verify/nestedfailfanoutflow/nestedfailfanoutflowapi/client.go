...
func (_c Executor) TaskA(ctx context.Context) (outers []int, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Outers, err
}

// TaskO creates and runs the TaskO task.
func (_c Executor) TaskO(ctx context.Context, outerItem int) (inners []int, currentOuter int, err error) { // MARKER: TaskO
	var out TaskOOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskO.Method, TaskO.Route, TaskOIn{OuterItem: outerItem}, &out, _c.inFlow, _c.outFlow)
	return out.Inners, out.CurrentOuter, err
}

// TaskI creates and runs the TaskI task.
func (_c Executor) TaskI(ctx context.Context, currentOuter int, innerItem int) (err error) { // MARKER: TaskI
	var out TaskIOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskI.Method, TaskI.Route, TaskIIn{CurrentOuter: currentOuter, InnerItem: innerItem}, &out, _c.inFlow, _c.outFlow)
	return err
}

// JoinI creates and runs the JoinI task.
func (_c Executor) JoinI(ctx context.Context) (err error) { // MARKER: JoinI
	var out JoinIOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, JoinI.Method, JoinI.Route, JoinIIn{}, &out, _c.inFlow, _c.outFlow)
	return err
}

// JoinO creates and runs the JoinO task.
func (_c Executor) JoinO(ctx context.Context) (done bool, err error) { // MARKER: JoinO
	var out JoinOOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, JoinO.Method, JoinO.Route, JoinOIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err
}

// Nested creates and runs the Nested workflow.
func (_c Executor) Nested(ctx context.Context) (done bool, status string, err error) { // MARKER: Nested
	if _c.runner == nil {
