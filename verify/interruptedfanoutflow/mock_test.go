...
func TestInterruptedfanoutflow_Mock(t *testing.T) {
	...
	t.Run("b", func(t *testing.T) { // MARKER: B
		...
		mock.MockB(func(ctx context.Context, flow *workflow.Flow, resumed bool) (executedOut int, err error) {
			return
		})
		var resumed bool
	...
	t.Run("interrupted_fan_out", func(t *testing.T) { // MARKER: InterruptedFanOut
		...
		mock.MockInterruptedFanOut(func(ctx context.Context, flow *workflow.Flow) (executed int, totalExecuted int, err error) {
			return
		})
