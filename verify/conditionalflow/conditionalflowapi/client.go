...
*/
func (_c Executor) TaskA(ctx context.Context, score int) (scoreOut int, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{Score: score}, &out, _c.inFlow, _c.outFlow)
	return out.ScoreOut, err
}

/*
TaskHigh creates and runs the TaskHigh task.
*/
func (_c Executor) TaskHigh(ctx context.Context, score int) (branch string, err error) { // MARKER: TaskHigh
	var out TaskHighOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskHigh.Method, TaskHigh.Route, TaskHighIn{Score: score}, &out, _c.inFlow, _c.outFlow)
	return out.Branch, err
}

/*
TaskLow creates and runs the TaskLow task.
*/
func (_c Executor) TaskLow(ctx context.Context, score int) (branch string, err error) { // MARKER: TaskLow
	var out TaskLowOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskLow.Method, TaskLow.Route, TaskLowIn{Score: score}, &out, _c.inFlow, _c.outFlow)
	return out.Branch, err
}
...
*/
func (_c Executor) TaskC(ctx context.Context, branch string) (finalBranch string, err error) { // MARKER: TaskC
	var out TaskCOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskC.Method, TaskC.Route, TaskCIn{Branch: branch}, &out, _c.inFlow, _c.outFlow)
	return out.FinalBranch, err
}

/*
Conditional creates and runs the Conditional workflow, blocking until termination.
*/
func (_c Executor) Conditional(ctx context.Context, score int) (finalBranch string, status string, err error) { // MARKER: Conditional
	if _c.runner == nil {
		return finalBranch, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out ConditionalOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Conditional.URL(), ConditionalIn{Score: score}, &out)
	return out.FinalBranch, status, err
}
