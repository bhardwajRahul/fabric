...
package onerrorsiblingsflowapi
...
*/
func (_c Executor) TaskB(ctx context.Context, started bool) (markB bool, err error) { // MARKER: TaskB
	var out TaskBOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskB.Method, TaskB.Route, TaskBIn{Started: started}, &out, _c.inFlow, _c.outFlow)
	return out.MarkB, err
}

/*
TaskC creates and runs the TaskC task.
*/
func (_c Executor) TaskC(ctx context.Context, started bool) (markC bool, err error) { // MARKER: TaskC
	var out TaskCOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskC.Method, TaskC.Route, TaskCIn{Started: started}, &out, _c.inFlow, _c.outFlow)
	return out.MarkC, err
}

/*
TaskD creates and runs the TaskD task.
*/
func (_c Executor) TaskD(ctx context.Context, started bool) (markD bool, err error) { // MARKER: TaskD
	var out TaskDOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskD.Method, TaskD.Route, TaskDIn{Started: started}, &out, _c.inFlow, _c.outFlow)
	return out.MarkD, err
}

/*
Handler creates and runs the Handler task.
*/
func (_c Executor) Handler(ctx context.Context, onErr *errors.TracedError) (handled bool, err error) { // MARKER: Handler
	var out HandlerOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Handler.Method, Handler.Route, HandlerIn{OnErr: onErr}, &out, _c.inFlow, _c.outFlow)
...
*/
func (_c Executor) TaskE(ctx context.Context, handled, markB, markC, markD bool) (recovered, siblingsRan bool, err error) { // MARKER: TaskE
	var out TaskEOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskE.Method, TaskE.Route, TaskEIn{Handled: handled, MarkB: markB, MarkC: markC, MarkD: markD}, &out, _c.inFlow, _c.outFlow)
	return out.Recovered, out.SiblingsRan, err
}

/*
FanOutError creates and runs the FanOutError workflow.
*/
func (_c Executor) FanOutError(ctx context.Context) (recovered, siblingsRan bool, status string, err error) { // MARKER: FanOutError
	if _c.runner == nil {
		return recovered, siblingsRan, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out FanOutErrorOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, FanOutError.URL(), FanOutErrorIn{}, &out)
	return out.Recovered, out.SiblingsRan, status, err
}
