...
func (svc *Mock) MockFailedFanOut(handler func(ctx context.Context, flow *workflow.Flow) (executed int, totalExecuted int, err error)) *Mock { // MARKER: FailedFanOut
	...
	err := svc.Subscribe(mockName, func(w http.ResponseWriter, r *http.Request) error {
		...
		out := failedfanoutflowapi.FailedFanOutOut{Executed: executed, TotalExecuted: totalExecuted}
