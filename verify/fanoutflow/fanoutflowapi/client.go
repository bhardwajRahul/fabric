...
*/
func (_c Executor) TaskA(ctx context.Context) (markA bool, err error) { // MARKER: TaskA
	var out TaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskA.Method, TaskA.Route, TaskAIn{}, &out, _c.inFlow, _c.outFlow)
	return out.MarkA, err // No trace
}

/*
TaskB creates and runs the TaskB task.
*/
func (_c Executor) TaskB(ctx context.Context, markA bool) (markB bool, err error) { // MARKER: TaskB
	var out TaskBOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskB.Method, TaskB.Route, TaskBIn{MarkA: markA}, &out, _c.inFlow, _c.outFlow)
	return out.MarkB, err // No trace
}

/*
TaskC creates and runs the TaskC task.
*/
func (_c Executor) TaskC(ctx context.Context, markA bool) (markC bool, err error) { // MARKER: TaskC
	var out TaskCOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskC.Method, TaskC.Route, TaskCIn{MarkA: markA}, &out, _c.inFlow, _c.outFlow)
	return out.MarkC, err // No trace
}

/*
TaskD creates and runs the TaskD task.
*/
func (_c Executor) TaskD(ctx context.Context, markA bool) (markD bool, err error) { // MARKER: TaskD
	var out TaskDOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskD.Method, TaskD.Route, TaskDIn{MarkA: markA}, &out, _c.inFlow, _c.outFlow)
	return out.MarkD, err // No trace
}

/*
TaskE creates and runs the TaskE task.
*/
func (_c Executor) TaskE(ctx context.Context, markB bool, markC bool, markD bool) (allMarked bool, err error) { // MARKER: TaskE
	var out TaskEOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskE.Method, TaskE.Route, TaskEIn{MarkB: markB, MarkC: markC, MarkD: markD}, &out, _c.inFlow, _c.outFlow)
	return out.AllMarked, err // No trace
}

/*
FanOut creates and runs the FanOut workflow, blocking until termination.
*/
func (_c Executor) FanOut(ctx context.Context) (allMarked bool, status string, err error) { // MARKER: FanOut
	if _c.runner == nil {
		return allMarked, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out FanOutOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, FanOut.URL(), FanOutIn{}, &out)
	return out.AllMarked, status, err
}
