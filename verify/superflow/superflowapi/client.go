...
*/
func (_c Executor) TaskA(ctx context.Context) (err error) { // MARKER: TaskA
	var out TaskAOut
...
*/
func (_c Executor) TaskB(ctx context.Context) (err error) { // MARKER: TaskB
	var out TaskBOut
...
*/
func (_c Executor) TaskC(ctx context.Context) (err error) { // MARKER: TaskC
	var out TaskCOut
...
*/
func (_c Executor) TaskD(ctx context.Context) (err error) { // MARKER: TaskD
	var out TaskDOut
...
*/
func (_c Executor) TaskE(ctx context.Context) (err error) { // MARKER: TaskE
	var out TaskEOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, TaskE.Method, TaskE.Route, TaskEIn{}, &out, _c.inFlow, _c.outFlow)
	return err // No trace
}
...
*/
func (_c Executor) TaskZ(ctx context.Context) (err error) { // MARKER: TaskZ
	var out TaskZOut
...
/*
ErrorHandler creates and runs the ErrorHandler task.
*/
func (_c Executor) ErrorHandler(ctx context.Context) (err error) { // MARKER: ErrorHandler
	var out ErrorHandlerOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, ErrorHandler.Method, ErrorHandler.Route, ErrorHandlerIn{}, &out, _c.inFlow, _c.outFlow)
	return err // No trace
}

/*
SubTaskA creates and runs the SubTaskA task.
*/
func (_c Executor) SubTaskA(ctx context.Context) (err error) { // MARKER: SubTaskA
	var out SubTaskAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, SubTaskA.Method, SubTaskA.Route, SubTaskAIn{}, &out, _c.inFlow, _c.outFlow)
	return err // No trace
}

/*
SubTaskB creates and runs the SubTaskB task.
*/
func (_c Executor) SubTaskB(ctx context.Context) (err error) { // MARKER: SubTaskB
	var out SubTaskBOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, SubTaskB.Method, SubTaskB.Route, SubTaskBIn{}, &out, _c.inFlow, _c.outFlow)
	return err // No trace
}

/*
Super creates and runs the Super workflow, blocking until termination.
*/
func (_c Executor) Super(ctx context.Context, items []string, useSubgraph bool, behaviors map[string]TaskBehavior) (status string, err error) { // MARKER: Super
	if _c.runner == nil {
		return "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out SuperOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Super.URL(), SuperIn{
		Items:       items,
...
/*
SuperSub creates and runs the SuperSub workflow, blocking until termination.
*/
func (_c Executor) SuperSub(ctx context.Context, behaviors map[string]TaskBehavior) (status string, err error) { // MARKER: SuperSub
	if _c.runner == nil {
		return "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out SuperSubOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, SuperSub.URL(), SuperSubIn{
		Behaviors: behaviors,
	}, &out)
	return status, err
}
