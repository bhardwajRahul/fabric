...
/*
Seed creates and runs the Seed task.
*/
func (_c Executor) Seed(ctx context.Context) (done bool, err error) { // MARKER: Seed
	var out SeedOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Seed.Method, Seed.Route, SeedIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
FanA creates and runs the FanA task.
*/
func (_c Executor) FanA(ctx context.Context) (done bool, err error) { // MARKER: FanA
	var out FanAOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, FanA.Method, FanA.Route, FanAIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
Work creates and runs the Work task.
*/
func (_c Executor) Work(ctx context.Context) (done bool, err error) { // MARKER: Work
	var out WorkOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Work.Method, Work.Route, WorkIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
Collect creates and runs the Collect task.
*/
func (_c Executor) Collect(ctx context.Context) (done bool, err error) { // MARKER: Collect
	var out CollectOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Collect.Method, Collect.Route, CollectIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
Loop creates and runs the Loop task.
*/
func (_c Executor) Loop(ctx context.Context) (done bool, err error) { // MARKER: Loop
	var out LoopOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Loop.Method, Loop.Route, LoopIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
BoomR creates and runs the BoomR task.
*/
func (_c Executor) BoomR(ctx context.Context) (done bool, err error) { // MARKER: BoomR
	var out BoomROut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, BoomR.Method, BoomR.Route, BoomRIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
Recover creates and runs the Recover task.
*/
func (_c Executor) Recover(ctx context.Context) (done bool, err error) { // MARKER: Recover
	var out RecoverOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Recover.Method, Recover.Route, RecoverIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
BoomF creates and runs the BoomF task.
*/
func (_c Executor) BoomF(ctx context.Context) (done bool, err error) { // MARKER: BoomF
	var out BoomFOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, BoomF.Method, BoomF.Route, BoomFIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}
...
*/
func (_c Executor) Join(ctx context.Context) (done bool, err error) { // MARKER: Join
	var out JoinOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, Join.Method, Join.Route, JoinIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
InnerEntry creates and runs the InnerEntry task.
*/
func (_c Executor) InnerEntry(ctx context.Context) (done bool, err error) { // MARKER: InnerEntry
	var out InnerEntryOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, InnerEntry.Method, InnerEntry.Route, InnerEntryIn{}, &out, _c.inFlow, _c.outFlow)
	return out.Done, err // No trace
}

/*
Soak creates and runs the Soak workflow, blocking until termination.
*/
func (_c Executor) Soak(ctx context.Context) (done bool, status string, err error) { // MARKER: Soak
	if _c.runner == nil {
		return done, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out SoakOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Soak.URL(), SoakIn{}, &out)
	return out.Done, status, err
}

/*
Inner creates and runs the Inner workflow, blocking until termination.
*/
func (_c Executor) Inner(ctx context.Context) (done bool, status string, err error) { // MARKER: Inner
	if _c.runner == nil {
		return done, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out InnerOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, Inner.URL(), InnerIn{}, &out)
	return out.Done, status, err
}
