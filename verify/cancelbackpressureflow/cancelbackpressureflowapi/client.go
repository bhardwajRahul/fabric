...
/*
BounceAndCancel creates and runs the BounceAndCancel task.
*/
func (_c Executor) BounceAndCancel(ctx context.Context, tag string) (tallied bool, err error) { // MARKER: BounceAndCancel
	var out BounceAndCancelOut
	err = marshalTask(ctx, _c.svc, _c.opts, _c.host, BounceAndCancel.Method, BounceAndCancel.Route, BounceAndCancelIn{Tag: tag}, &out, _c.inFlow, _c.outFlow)
	return out.Tallied, err // No trace
}

/*
CancelBackpressure creates and runs the CancelBackpressure workflow.
*/
func (_c Executor) CancelBackpressure(ctx context.Context, tag string) (tallied bool, status string, err error) { // MARKER: CancelBackpressure
	if _c.runner == nil {
		return tallied, "", errors.New("workflow runner not set, use WithWorkflowRunner")
	}
	var out CancelBackpressureOut
	status, err = marshalWorkflow(ctx, _c.runner, _c.flowOptions, CancelBackpressure.URL(), CancelBackpressureIn{Tag: tag}, &out)
