...
func (_c Client) HelloWorld(ctx context.Context, relativeURL string) (res *http.Response, err error) { // MARKER: HelloWorld
	return _c.svc.Request(
		ctx,
		pub.Method(HelloWorld.Method),
		pub.URL(httpx.JoinHostAndPath(_c.host, HelloWorld.Route)),
...
If a URL is provided, it is resolved relative to the URL of the endpoint.
*/
func (_c MulticastClient) HelloWorld(ctx context.Context, relativeURL string) iter.Seq[*pub.Response] { // MARKER: HelloWorld
