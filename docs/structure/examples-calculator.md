...
The `/distance` endpoint demonstrates the use of a complex type `Point`. When a complex type is used in an endpoint, it must be defined in the API package because it is considered part of the microservice's public API.
